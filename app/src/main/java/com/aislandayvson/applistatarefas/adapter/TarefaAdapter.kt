package com.aislandayvson.applistatarefas.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.aislandayvson.applistatarefas.databinding.ItemTarefaBinding
import com.aislandayvson.applistatarefas.model.Tarefa

class TarefaAdapter(
    val onCliqueExcluir: (Int) -> Unit,
    val onCliqueEditar: (Tarefa) -> Unit
